...
(function ($, undefined) {
    ...
    var defaults = {
        ...
        //    day: "День"
            ...
            //buttonText: {
        //	prev: "<span class='fc-text-arrow'>&lsaquo;</span>",fc-header-center
    ...
    */
    ...
    function AgendaEventRenderer() {
            ...
            for (i = 0; i < segCnt; i++) {
                ...
                if (levelI) {
                    ...
                    if (forward) {
                    	...
                    	outerWidth = availWidth / (levelI + forward + 1);//outerWidth = ((availWidth / (forward + 1)) - (12 / 2)) * 2; // 12 is the predicted width of resizer =
                    } else {
                ...
                if (eventElement = seg.element) {
                    ...
                    if (seg.contentTop !== undefined && height - seg.contentTop < 10) {
                        ...
                        eventElement.find('div.fc-event-time')
                            .text(formatDate(event.start, opt('timeFormat')) + ' - ' + event.title + ' - ' + event.description);
        ...
        function slotSegHtml(event, seg) {
            ...
            html +=
              ...
              "<div class='fc-event-title' style='font-size:14px;'>" +  htmlEscape(event.TypeIvent) +"  "+ 
              htmlEscape(formatDate(event.start, opt('timeFormat'))) + htmlEscape(event.Money)+ "<b>" + "</b>" + "<b>   " + htmlEscape(event.Topic) + "</b>" +
              htmlEscape(event.title) + ". " + "<b>  </b>" + htmlEscape(event.description) +
              "</div>" +
              //"<div class='fc-event-title' style='font-size:13px'>" + 
              //"</div>" + 
              "</div>" +
    ...
    function DayEventRenderer() {
        ...
        function buildHTMLForSegment(segment) {
            ...
            html +=
                "<span class='fc-event-title'>" + htmlEscape(event.title) + "</span>" + "<span class='fc-event-title'>" + htmlEscape(event.description) + "</span>" +
                "</div>";
